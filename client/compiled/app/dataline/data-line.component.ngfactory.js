...
var _View_DataLineComponent_Host0 = (function (_super) {
    ...
    Object.defineProperty(_View_DataLineComponent_Host0.prototype, "_CardWidgetComponent_0_6", {
        get: function () {
            if ((this.__CardWidgetComponent_0_6 == null)) {
                (this.__CardWidgetComponent_0_6 = new import5.CardWidgetComponent());
            }
    ...
    _View_DataLineComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import5.CardWidgetComponent) && (0 === requestNodeIndex))) {
            return this._CardWidgetComponent_0_6;
        }
...
var _View_DataLineComponent0 = (function (_super) {
    ...
    _View_DataLineComponent0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_6 = import13.viewFactory_CardWidgetComponent0(this.viewUtils, this.injector(6), this._appEl_6);
        this._CardWidgetComponent_6_4 = new import5.CardWidgetComponent();
        this._appEl_6.initComponent(this._CardWidgetComponent_6_4, [], compView_6);
        ...
        compView_6.create(this._CardWidgetComponent_6_4, [[].concat([
                this._text_7,
                this._el_8,
                this._text_10,
                this._el_11,
    ...
    _View_DataLineComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import5.CardWidgetComponent) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
            return this._CardWidgetComponent_6_4;
        }
        return notFoundResult;
    };
...
//# sourceMappingURL=data-line.component.ngfactory.js.map