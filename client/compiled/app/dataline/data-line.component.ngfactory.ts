...
import * as import13 from '../widget/card-widget.component.ngfactory';
...
class _View_DataLineComponent_Host0 extends import1.AppView<any> {
  ...
  __CardWidgetComponent_0_6:import5.CardWidgetComponent;
  ...
  get _CardWidgetComponent_0_6():import5.CardWidgetComponent {
    if ((this.__CardWidgetComponent_0_6 == (null as any))) { (this.__CardWidgetComponent_0_6 = new import5.CardWidgetComponent()); }
    return this.__CardWidgetComponent_0_6;
  }
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import5.CardWidgetComponent) && (0 === requestNodeIndex))) { return this._CardWidgetComponent_0_6; }
...
class _View_DataLineComponent0 extends import1.AppView<import4.DataLineComponent> {
  ...
  _CardWidgetComponent_6_4:import5.CardWidgetComponent;
  _text_7:any;
  _el_8:any;
  _text_9:any;
  _text_10:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    var compView_6:any = import13.viewFactory_CardWidgetComponent0(this.viewUtils,this.injector(6),this._appEl_6);
    this._CardWidgetComponent_6_4 = new import5.CardWidgetComponent();
    this._appEl_6.initComponent(this._CardWidgetComponent_6_4,([] as any[]),compView_6);
    ...
    this._text_13 = this.renderer.createText((null as any),'\n      ',(null as any));
      compView_6.create(this._CardWidgetComponent_6_4,[([] as any[]).concat([
        this._text_7,
        this._el_8,
        this._text_10,
        this._el_11,
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import5.CardWidgetComponent) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._CardWidgetComponent_6_4; }
    return notFoundResult;
  }
