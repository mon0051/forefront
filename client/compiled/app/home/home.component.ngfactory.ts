...
import * as import10 from '../../../app/widget/card-widget.component';
import * as import11 from '../widget/card-widget.component.ngfactory';
...
class _View_HomeComponent0 extends import1.AppView<import3.HomeComponent> {
  ...
  _CardWidgetComponent_4_4:import10.CardWidgetComponent;
  _text_5:any;
  _text_6:any;
  _text_7:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_4 = this.renderer.createElement(this._el_2,'card-widget',(null as any));
    this.renderer.setElementAttribute(this._el_4,'class','col-sm-3');
    this._appEl_4 = new import2.AppElement(4,2,this,this._el_4);
    var compView_4:any = import11.viewFactory_CardWidgetComponent0(this.viewUtils,this.injector(4),this._appEl_4);
    this._CardWidgetComponent_4_4 = new import10.CardWidgetComponent();
    this._appEl_4.initComponent(this._CardWidgetComponent_4_4,([] as any[]),compView_4);
    this._text_5 = this.renderer.createText((null as any),'\n            Homepage dashboard junk\n        ',(null as any));
    compView_4.create(this._CardWidgetComponent_4_4,[([] as any[]).concat([this._text_5])],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import10.CardWidgetComponent) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 5)))) { return this._CardWidgetComponent_4_4; }
    return notFoundResult;
  }
}
