...
var _View_TypographyThingerComponent_Host0 = (function (_super) {
    ...
    function _View_TypographyThingerComponent_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_TypographyThingerComponent_Host0, renderType_TypographyThingerComponent_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_TypographyThingerComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('typography-thinger', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_TypographyThingerComponent0(this.viewUtils, this.injector(0), this._appEl_0);
        this._TypographyThingerComponent_0_4 = new import3.TypographyThingerComponent();
        this._appEl_0.initComponent(this._TypographyThingerComponent_0_4, [], compView_0);
        compView_0.create(this._TypographyThingerComponent_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_TypographyThingerComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.TypographyThingerComponent) && (0 === requestNodeIndex))) {
            return this._TypographyThingerComponent_0_4;
        }
        return notFoundResult;
    };
    return _View_TypographyThingerComponent_Host0;
}(import1.AppView));
function viewFactory_TypographyThingerComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TypographyThingerComponent_Host === null)) {
        (renderType_TypographyThingerComponent_Host = viewUtils.createRenderComponentType('', 0, import8.ViewEncapsulation.None, [], {}));
    }
...
var _View_TypographyThingerComponent0 = (function (_super) {
    __extends(_View_TypographyThingerComponent0, _super);
    function _View_TypographyThingerComponent0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_TypographyThingerComponent0, renderType_TypographyThingerComponent, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_TypographyThingerComponent0.prototype.createInternal = function (rootSelector) {
    ...
    _View_TypographyThingerComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_TypographyThingerComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
        changes = null;
    ...
    _View_TypographyThingerComponent0.prototype.destroyInternal = function () {
        this._NgModel_17_6.ngOnDestroy();
        this._NgModel_25_6.ngOnDestroy();
        this._NgModel_33_6.ngOnDestroy();
    };
    _View_TypographyThingerComponent0.prototype._handle_ngModelChange_17_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = ((this.context.fontSize = $event) !== false);
        return (true && pd_0);
    };
    _View_TypographyThingerComponent0.prototype._handle_change_17_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
    ...
    _View_TypographyThingerComponent0.prototype._handle_input_17_2 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_17_3.onChange($event.target.value) !== false);
        var pd_1 = (this._NumberValueAccessor_17_4.onChange($event.target.value) !== false);
        return ((true && pd_0) && pd_1);
    };
    _View_TypographyThingerComponent0.prototype._handle_blur_17_3 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_17_3.onTouched() !== false);
        var pd_1 = (this._NumberValueAccessor_17_4.onTouched() !== false);
        return ((true && pd_0) && pd_1);
    };
    _View_TypographyThingerComponent0.prototype._handle_ngModelChange_25_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = ((this.context.lineHeight = $event) !== false);
        return (true && pd_0);
    };
    _View_TypographyThingerComponent0.prototype._handle_change_25_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
    ...
    _View_TypographyThingerComponent0.prototype._handle_input_25_2 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_25_3.onChange($event.target.value) !== false);
        var pd_1 = (this._NumberValueAccessor_25_4.onChange($event.target.value) !== false);
        return ((true && pd_0) && pd_1);
    };
    _View_TypographyThingerComponent0.prototype._handle_blur_25_3 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_25_3.onTouched() !== false);
        var pd_1 = (this._NumberValueAccessor_25_4.onTouched() !== false);
        return ((true && pd_0) && pd_1);
    };
    _View_TypographyThingerComponent0.prototype._handle_ngModelChange_33_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = ((this.context.lineWidth = $event) !== false);
        return (true && pd_0);
    };
    _View_TypographyThingerComponent0.prototype._handle_change_33_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
    ...
    _View_TypographyThingerComponent0.prototype._handle_input_33_2 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_33_3.onChange($event.target.value) !== false);
        var pd_1 = (this._NumberValueAccessor_33_4.onChange($event.target.value) !== false);
        return ((true && pd_0) && pd_1);
    };
    _View_TypographyThingerComponent0.prototype._handle_blur_33_3 = function ($event) {
        this.markPathToRootAsCheckOnce();
