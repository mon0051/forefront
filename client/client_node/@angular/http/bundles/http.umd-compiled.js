...
(function (global, factory) {
    ...
    var Headers = function () {
        ...
        Headers.prototype.toJSON = function () {
            ...
            this._headersMap.forEach(function (values, name) {
                var list = [];
                iterateListLike(values, function (val /** TODO #9100 */) {
    ...
    function normalizeMethodName(method) {
        if (isString(method)) {
            ...
            if (typeof method !== 'number') throw makeTypeError("Invalid request method. The method \"" + originalMethod + "\" is not supported.");
        }
        return method;
    }
    ...
    var w = (typeof window === 'undefined' ? 'undefined' : _typeof(window)) == 'object' ? window : noop$1;
...
//# sourceMappingURL=http.umd-compiled.js.map